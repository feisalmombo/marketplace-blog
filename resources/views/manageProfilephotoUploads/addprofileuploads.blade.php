...
@section('content')
<div class="col-lg-12">
	<h1 class="page-header">Upload Profile Photo</h1>
</div>
	...
	<div class="col-lg-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				Photo<a href="{{ url('/view-users/profile/photo/upload') }}" class="col-2 pull-right" style="text-decoration: none;"><i class="fa fa-arrow-left"></i>&nbsp;Back</a>
			</div>
